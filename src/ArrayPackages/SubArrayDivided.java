...
public class SubArrayDivided
{
    public static void main(String[] args)
    {
        // Your code for the main method goes here, if needed
        int[] nums = {-2, 1, -3, 4, -1, 2, 1, -5, 4};
        int result = maxSubArrayDivided(nums);
        System.out.println("Maximum subarray divided: " + result);
    }
    public static int maxSubArrayDivided(int[] nums) {
